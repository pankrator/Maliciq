...
public abstract class LivingEntity extends GameObject {
	 ...
	 * 
	 * @param pointX
	 *            x coordinates to look for
	 * @param pointY
	 *            y coordinates to look for
	 * @return the direction where (pointX,pointY) is or -1 if the direction
	 ...
	 * @return the direction where (targetX,targetY) is or -1 if the direction
	 *         cannot be determined
	 */
	public final byte pointDirection(GameObject target) {
